...
class HelpWindow(QMessageBox):
    """Okno pomocy - NAPRAWIONE z HTML"""
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Help")
        self.setIcon(QMessageBox.Icon.Information)
        
        # Użyj HTML zamiast zwykłego tekstu!
        help_text = """
        <html>
        <body style="font-family: Arial; font-size: 11px; line-height: 1.6;">
        <h2>STEGANOGRAPHY GUI - Pomoc</h2>
        
        <h3>Co to jest?</h3>
        <p>Aplikacja do ukrywania tajnych wiadomości w plikach przy użyciu różnych algorytmów steganograficznych.</p>
        
        <h3>Jak korzystać?</h3>
        
        <h4>Zakładka ENCODE:</h4>
        <ol>
          <li>Wybierz algorytm z listy</li>
          <li>Wybierz źródło COVER TEXT:
            <ul>
              <li><b>File</b> - załaduj plik .txt (zalecane)</li>
              <li><b>Input</b> - wpisz tekst bezpośrednio</li>
            </ul>
          </li>
          <li>Wybierz źródło SECRET MESSAGE:
            <ul>
              <li><b>File</b> - załaduj plik .txt</li>
              <li><b>Input</b> - wpisz wiadomość bezpośrednio</li>
            </ul>
          </li>
          <li>Wpisz nazwę pliku wyjściowego (rozszerzenie dodawane automatycznie)</li>
          <li>Kliknij <b>ENCODE</b></li>
        </ol>
        
        <h4>Zakładka DECODE:</h4>
        <ol>
          <li>Wybierz algorytm (ten sam co przy encodowaniu!)</li>
          <li>Załaduj plik zakodowany (stego_output)</li>
          <li>Opcjonalnie: wskaż plik do zapisu wyniku</li>
          <li>Kliknij <b>DECODE</b></li>
        </ol>
        ...
        <h3>Porady:</h3>
        <ul>
          <li>Zawsze używaj tego samego algorytmu do encode i decode</li>
          <li>Cover text musi być dłuższy niż secret message</li>
          <li>Dla PDF: <code>pip install PyMuPDF reportlab</code></li>
          <li>Dla algorytmu Emoticon: upewnij się że Ollama serwer działa</li>
        </ul>
        </body>
        </html>
        """
